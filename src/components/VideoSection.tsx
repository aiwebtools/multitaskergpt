...
const VideoSection: React.FC = () => {
  ...
  return <section className="section py-24 bg-cyber-dark/30" id="video">
      ...
      <div ref={containerRef} className="max-w-4xl mx-auto rounded-xl overflow-hidden cyber-border shadow-[0_0_30px_rgba(0,238,255,0.2)] opacity-0">
        <div className="relative pb-[56.25%] h-0 overflow-hidden">
          <iframe ref={videoRef} className="absolute top-0 left-0 w-full h-full" src="https://www.youtube.com/embed/MCAjBSrrvx4?autoplay=1&mute=0&controls=1&showinfo=0&rel=0&modestbranding=1&hd=1" title="MULTITASKER GPT Demo" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
        </div>
      </div>
