  ...
  return (
    <section className="section py-24 bg-cyber-dark/30" id="video">
      <div className="text-center mb-12">
        <h2 className="heading-lg mb-4 title-gradient inline-block">See MULTITASKER GPT in Action</h2>
      ...
      <div 
        ref={containerRef} 
        className="max-w-4xl mx-auto rounded-xl overflow-hidden cyber-border shadow-[0_0_30px_rgba(0,238,255,0.2)] opacity-0"
      >
